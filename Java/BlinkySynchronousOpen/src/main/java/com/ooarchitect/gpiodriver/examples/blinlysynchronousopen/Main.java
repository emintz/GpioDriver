 ...
 *
 * <p>The application opens its output pin synchronously. In addition to
 * providing an example of use, it illustrates the improved
 * pin open UX.
 */
public class Main {
   ...
   */
  void blink() {
    OutputPin writeToBuiltinLed =
        null;
    try {
      writeToBuiltinLed = gpio.synchronousOpenForOutput(ESP32s2Pin.GPIO_2, new IOStatusConsumer());
